...
#cambia la fecha de expiracion del token
app.config['JWT_EXPIRATION_DELTA'] = timedelta(minutes=30)
#cambia el parametro en el cual pedira el nombre del usuario
app.config['JWT_AUTH_USERNAME_KEY'] = 'email'
#cambia el endpoint en el cual se harà la autenticación
...
def prueba_jinja():
    ...
    return render_template('pruebas.jinja',nombre='Christian',
    saludo='Buenas noches', productos=productos,
    masculinos=masculinos, femeninas=femeninas)
