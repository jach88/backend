...
class ComprobanteSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        '''Se llamara automaicamente cuando se llame al metodo is_valid() en el controlador'''
        #recibe la data que esta enviando el usuario, ademas de hacer la validacion de tipos, longitudes minimas maximas y otras validaciones se pueden hacer las propias validaciones y si todo esta conforme entonces retornamos la data proveida caso contrario
        try:
