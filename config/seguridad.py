...
def identificador(payload):
    '''Sirve para que una vez eñ usuario envie la token y quiera realizar una peticon a una ruta protegida esta funcion sera encargada de indentificar a dicho usuario y devolver su informacion'''
    print(payload)
