...
class ClientesTestCase(APITestCase):
    def setUp(self):
        ClienteModel(clienteNombre='JULCA ALVARADO, CHRISTIAN ANTONIO',
        clienteDocumento='43823515', clienteDireccion='Calle las rosas 335').save
    ...
    def test_post_cliente_success(self):
        ...
        nuevoCliente = {
            "clienteDocumento":"43823515",
            "clienteDireccion":"calle las rosas 335"
        }
    ...
    def test_post_cliente_exist_fail(self):
        '''Deberia crear el cliente y devolverlo'''
        nuevoCliente = {
            "clienteDocumento":"43823515",
            "clienteDireccion":"calle las rosas 335"
