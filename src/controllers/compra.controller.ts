...
export const crearPreferencia =async (req:Request, res:Response)=>{
    //el metodo configure me sirve para configurar mi MercadoPAgo (MP) en toda la aplicacion, se le tiene que proveer los campos access_token e integrator_id
    //access_token => token que se usará POR CADA APLICACION (sirve para que MP sepa a que negocio tiene que depositar y demas en el extracto de cuenta del comprador colocar correctamente el nombre del negocio)
    ...
    configure ({ access_token: 
        "APP_USR-8208253118659647-112521-dd670f3fd6aa9147df51117701a2082e-677408439",integrator_id: "dev_24c65fb163bf11ea96500242ac130004",
     });
    ...
    payment_methods:{
        //excluded_payment_methods sirve para excluir los metodos de pago
        excluded_payment_methods:[{"id": "master"},{"id": "debmaster"}],
        //excluded_payment_types excluir los tipos de pago (credit_card, debit_card, atm(pago contra entrega))
        excluded_payment_types:[{id:"atm"}],
        //installments: numero maximo de cuotas permitido (en el caso que sea tarjeta de credito)
        installments:6,
    }
   };
   try {
