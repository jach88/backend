...
export class Server {
    ...
    // readonlu => no podra ser modificado su valor afuera del constructor
    ...
    public start(){
        this.app.listen(this.puerto, async()=>{
            ...
            // alter => tratara de cambiar la informacion modificada en el orm no la logra completar emitira un error
            await conexion.sync({});
